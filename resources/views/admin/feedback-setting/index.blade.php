                            ...
                            <form action="{{ route('admin.feedback-section-setting.update', 1) }}" method="post"
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <input type="text" name="title" class="form-control" value="{{ $feedback_title->title }}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row mb-4">
                                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Sub
                                        Title</label>
                                    <div class="col-sm-12 col-md-7">
                                        <textarea name="sub_title" id="" class="form-control"
                                                  style="height: 100px;">{{ $feedback_title->sub_title }}</textarea>
                                    </div>
                                </div>
